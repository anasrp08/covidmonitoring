...
<html lang="en">
    <head>
        ...
        <title>Login Peruri Covid</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4 @error('username') is-invalid @enderror" name="username" id="username" type="text" placeholder="Masukkan NP" value="{{ old('username') }}" required autocomplete="username" autofocus/>
                                            </div>
                                            <!-- Form Group (password)-->
                                            <div class="form-group">
                                                <label class="small mb-1" for="password">Password</label>
                                                <input class="form-control py-4 @error('password') is-invalid @enderror" name="password" id="password" type="password" placeholder="Masukkan password" required/>
                                            </div>
